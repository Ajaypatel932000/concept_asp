<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="Attendance.aspx.cs" Inherits="Admin_Attendance" %>
...
<div class="form-group">
    <table class="dropzone-previews">
        ...
        ID="Panel1" runat="server" onload="Panel1_Load">
                                          <br />
                                          <asp:Chart ID="Chart3" runat="server" DataSourceID="SqlDataSource1_Year" BackColor="LightSkyBlue" 
                         ...
                         <SelectParameters>
                             <asp:QueryStringParameter Name="Enrollment_Id" QueryStringField="attend" />
                         </SelectParameters>
                     </asp:SqlDataSource>
                     <br />
                     <br />
    ...
    <asp:Panel ID="Panel2" runat="server" onload="Panel2_Load">
        <asp:Chart ID="Chart2" runat="server" 
            DataSourceID="SqlDataSource1Monthly" 
            BackColor="LightSkyBlue" BackImageTransparentColor="LightSkyBlue">
            <Series>
                <asp:Series ChartType="Pie" Name="Series1" IsValueShownAsLabel="True" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1Monthly" runat="server" 
...
">
    ...
    &nbsp;</td>
            <td>
                ...
                <br />
                <span class="style2"><strong>Select Month :</strong></span>
...
<AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
        ...
        <SortedDescendingHeaderStyle BackColor="#002876" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1_attendance" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString_CONCEPT %>" 
                    SelectCommand="SELECT CONVERT (varchar, A_Date, 3) AS DATE, CASE Status WHEN 'True' THEN 'ABSENT' ELSE 'PRESENT' END AS STATUS FROM Attendance WHERE (Enrollment_Id = @Enrollment_Id) AND (MONTH(A_Date) = @A_Date)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="Enrollment_Id" QueryStringField="attend" />
                        <asp:ControlParameter ControlID="DropDownList1" Name="A_Date" 
                            PropertyName="SelectedValue" />
        ...
        <tr>
            <td align="right" colspan="2">
                 <asp:Button ID="Button1" runat="server" PostBackUrl="~/ADMIN_/Student.aspx" 
                     Text="Back" Font-Size="Large" Height="35px" Width="106px" />
            </td>
        </tr>
    </table>
    </div>
