...
public partial class Admin_Attendance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.ConnectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Mansuri\Desktop\Project_Testing\Concept_class\App_Data\ASPNETDB.MDF;Integrated Security=True;User Instance=True";
        cn.Open();
        Label2.Text = Request.QueryString["attend"];
