<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="TestReport.aspx.cs" Inherits="Student_TestReport" %>
                    ...
                    <tr>
                        <td bgcolor="#FFCCCC" class="style14">
                            ...
                            &nbsp;<asp:Label ID="Label4" runat="server" ForeColor="Black" 
                                Text="Negetive Answered" Width="130px"></asp:Label>
                            <br />
                        </td>
