        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="134px" Width="104px">
                    </asp:Panel> 
                    </td>
            </tr>
            <tr>
                <td align="center" valign="top">
                    <asp:Button ID="Button2" runat="server" class="btn btn-rounded btn-primary" Height="44px"  Width="130px" onclick="Button2_Click" Text="Submit" />
                    </td>
            </tr>
        </table>
