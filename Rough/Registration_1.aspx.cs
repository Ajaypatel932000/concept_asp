...
public partial class Registration : System.Web.UI.Page
{
    ...
    protected void CreateUserWizard1_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        {
            Profile.ProfilePic = "NoProfile.jpg";
        }
        ...
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = "INSERT INTO Student (Birth_Date, M_Mobile_No, F_Mobile_No,UserName) VALUES ('2000-03-09' , '" + TextBox_Mother1.Text + "' , '" + TextBox_Father1.Text + "' , '" + Label11.Text + "')";
        cmd.Connection = cn;
        cmd.ExecuteNonQuery();
